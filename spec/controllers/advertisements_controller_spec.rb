...
#       get :show, {id: my_advertisement.id}
#       expect(assigns(:post)).to eq(my_advertisement)
#     end
#   end
#
#   describe "GET new" do
...
#       expect{advertisement :create, advertisement: {title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 50}}.to change (Advertisement,:count).by(1)
#     end
#
#     it "assigns the new advertisement to @advertisement" do
#       advertisement :create, advertisement: {title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 50}
